#imported from github.com/ravana69/PornHub to userbot by @PM_Alt2 
...
async def _(event):
    ...
    await event.edit("`Rename & Upload in process, Hehe It might take some time if file size is big`")
    input_str = event.pattern_match.group(1)
