...
# ========================= CONSTANTS ============================
UNAPPROVED_MSG = (
    "`HeY! Pratik Goswami PM Not Approved You in PM.\n\n`"
    "`Please Wait for Approve. Pratik Goswami PM Mostly Approve PMs.\n\n`"
    "`Until He Approve, Please Don't Spam Here, Otherwise You Will Reported as Spam!`")
# =================================================================
...
async def permitpm(event):
    """ Prohibits People from PMing You Without Approval. \
        Will Block That Retarded Nibbas Automatically. """
    if PM_AUTO_BAN:
        ...
        if event.is_private and event.chat_id != 777000 and event.chat_id != self_user.id and not (
            ...
            if not apprv and event.text != UNAPPROVED_MSG:
                ...
                if COUNT_PM[event.chat_id] > 4:
                    await event.respond(
                        "`You Were Spamming Pratik Goswami PM's PM, Which I Didn't Like.`\n"
                        "`You Have been BLOCKED && Reported as SPAM, Until Further Notice.`"
                    )
...
async def disapprovepm(disapprvpm):
    ...
    if BOTLOG:
        await disapprvpm.client.send_message(
            ...
            " Pratik Goswami PM Disapproved You to PM Chat.",
        )
