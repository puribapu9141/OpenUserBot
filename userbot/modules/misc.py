...
async def creator(e):
    await e.edit("[Pratik Goswami PM](https://github.com/puribapu9141)")
...
async def reedme(e):
    await e.edit(
        ...
        "\n[OpenUserBot's README.md file](https://github.com/puribapu9141/OpenUserBot/blob/sql-extended/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "Click [here](https://github.com/puribapu9141/OpenUserBot) to open OpenUserBot's GitHub page."
    )
...
async def myrepo_is_here(wannaseeme):
    ...
    await wannaseeme.edit(
        f'Click [here](https://github.com/OpenUserBot/tree/sql-extended/) to open Pratik Goswami PM`s GitHub page'
    )
